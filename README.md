...
## How To Play
- **Start the Game:** Press any key or click the mouse to begin.
- **Move the Train:**  
  - Press the **LEFT** arrow key to move the train to Gondangdia (left).
  - Press the **RIGHT** arrow key to move the train to Cikini (right).
- **Upgrade:**  
...
<a href="https://youtu.be/vSi4UqEW16I?si=IsQtca0tnVGbIxno" target="_blank">
  <img src="https://img.youtube.com/vi/vSi4UqEW16I/0.jpg" alt="Cikini to Gondangdia Gameplay Video" width="260"/>
</a>
...
## Credits
- **Rifki Setiawan** – Game Programmer  
